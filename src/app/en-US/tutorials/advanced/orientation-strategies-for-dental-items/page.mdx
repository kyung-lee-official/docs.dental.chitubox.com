export const metadata = {
	...
	openGraph: {
		images: [
			"/images/docs/en-US/advanced/orientation-strategies-for-dental-items/cover.png",
		],
	},
};
...
<BlogImageContainer
	src={
		"/images/docs/en-US/advanced/orientation-strategies-for-dental-items/image-of-the-dental-models-flatten-on-the-platform.png"
	}
	style={{ width: "540px" }}
...
<BlogImageContainer
	src={
		"/images/docs/en-US/advanced/orientation-strategies-for-dental-items/image-of-the-tooth-models-placed-vertically.png"
	}
	style={{ width: "540px" }}
...
<BlogImageContainer
	src={
		"/images/docs/en-US/advanced/orientation-strategies-for-dental-items/image-of-dental-models-automatically-oriented-in-chitubox-dental.gif"
	}
	style={{ width: "540px" }}
...
<BlogImageContainer
	src={
		"/images/docs/en-US/advanced/orientation-strategies-for-dental-items/image-of-the-orientation-outcome-of-the-implant-guide.png"
	}
	style={{ width: "360px" }}
...
<BlogImageContainer
	src={
		"/images/docs/en-US/advanced/orientation-strategies-for-dental-items/image-of-vertical-placement-of-base-plate.gif"
	}
	style={{ width: "540px" }}
...
<BlogImageContainer
	src={
		"/images/docs/en-US/advanced/orientation-strategies-for-dental-items/image-of-placing-the-adsorption-surface-upward.png"
	}
	style={{ width: "540px" }}
