export const metadata = {
	...
	openGraph: {
		images: [
			"/images/docs/en-US/advanced/parameter-configuration/cover.jpg",
		],
	},
};
...
<BlogImageContainer
	src={
		"/images/docs/en-US/advanced/parameter-configuration/use-preset-parameters.png"
	}
	style={{ width: "540px" }}
...
<BlogImageContainer
	src={
		"/images/docs/en-US/advanced/parameter-configuration/import-profiles.gif"
	}
	style={{ width: "540px" }}
...
<BlogImageContainer
	src={
		"/images/docs/en-US/advanced/parameter-configuration/set-parameters.gif"
	}
	style={{ width: "540px" }}
...
<BlogImageContainer
	src={
		"/images/docs/en-US/advanced/parameter-configuration/export-parameter.png"
	}
	style={{ width: "540px" }}
