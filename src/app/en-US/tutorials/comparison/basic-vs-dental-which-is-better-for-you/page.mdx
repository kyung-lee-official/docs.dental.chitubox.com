export const metadata = {
	...
	openGraph: {
		images: [
			"/images/docs/en-US/comparison/basic-vs-dental-which-is-better-for-you/cover.png",
		],
	},
};
...
<span className="text-gray-400"> Just like the feedback from many users, CHITUBOX Dental is an excellent slicing tool for digital dentistry, if you are struggling with the choice of slicing software, why not download and try it out? </span>
