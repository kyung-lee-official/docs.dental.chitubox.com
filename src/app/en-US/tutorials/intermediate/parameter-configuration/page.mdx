export const metadata = {
	...
	openGraph: {
		images: [
			"/images/docs/en-US/intermediate/parameter-configuration/cover.jpg",
		],
	},
};
...
CHITUBOX Dental has a large number of printer and material parameters presetted. You can select the machine you are using in the printer list, choose the material below, and then apply directly. If you want to fine-tune the presetting parameters, you can click the "Intermediate" button after selecting the printer and material.

<BlogImageContainer
	src={
		"/images/docs/en-US/intermediate/parameter-configuration/use-preset-parameters.png"
	}
	style={{ width: "600px" }}
	figcaption="Preset Paramaeters"
/>
...
<BlogImageContainer
	src={
		"/images/docs/en-US/intermediate/parameter-configuration/set-parameters.gif"
	}
	style={{ width: "600px" }}
	figcaption="Set Parameters"
/>
...
<BlogImageContainer
	src={
		"/images/docs/en-US/intermediate/parameter-configuration/export-parameter.png"
	}
	style={{ width: "600px" }}
	figcaption="Export Parameters"
/>
