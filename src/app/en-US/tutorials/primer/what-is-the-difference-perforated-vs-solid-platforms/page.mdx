export const metadata = {
	title: "What is the Difference: Perforated vs Solid Platforms",
	...
	openGraph: {
		images: ["/images/docs/en-US/primer/what-is-the-difference-perforated-vs-solid-platforms/cover3.png"],
	},
};

# What is the Difference: Perforated vs Solid Platforms 

Hello everyone, we discussed <Link href="https://dental.chitubox.com/en/article/dental/news/Education/2">*How to choose a dental printer*</Link> in the last issue, concluding that it is recommended to use the lift-style printer in most printing scenarios. However, in addition to the difference in optical structure, the lift-style printer also has differences in the type of platform, solid type and perforated type. In this issue, we will discuss these two platform's advantages and disadvantages.
...
Using lift-style printers, we need to add enough resin to the material vat at first. The platform will sink into the resin for UV-lighting, and then lift with the curing resin adhering on the platform. When the platform is lifted, the area around the platform has a pressure difference, so the resin will flow to these areas which will continue to prevent the platform from lifting until the platform separates from the resin vat. This pressure will affect the printing effect.
 ...
 <BlogImageContainer
	src={
    		"/images/docs/en-US/primer/what-is-the-difference-perforated-vs-solid-platforms/resin-flow-diagram.png"
	}
	style={{ width: "600px" }}
...
<BlogImageContainer
	src={
    		"/images/docs/en-US/primer/what-is-the-difference-perforated-vs-solid-platforms/perforated-platform-left-&-solid-platform-right.png"
	}
	style={{ width: "600px" }}
...
<BlogImageContainer
	src={
    		"/images/docs/en-US/primer/what-is-the-difference-perforated-vs-solid-platforms/drain-holes-in-the-model.gif"
	}
	style={{ width: "600px" }}
...
<BlogImageContainer
	src={
    		"/images/docs/en-US/primer/what-is-the-difference-perforated-vs-solid-platforms/rendering-of-the-perforated-platform-model.png"
	}
	style={{ width: "600px" }}
