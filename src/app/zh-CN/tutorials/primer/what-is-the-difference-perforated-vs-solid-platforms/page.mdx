export const metadata = {
	...
	openGraph: {
		images: ["/images/docs/zh-CN/primer/what-is-the-difference-perforated-vs-solid-platforms/cover3.png"],
	},
};
...
<BlogImageContainer
	src={
    		"/images/docs/zh-CN/primer/what-is-the-difference-perforated-vs-solid-platforms/resin-flow-diagram.png"
	}
	style={{ width: "600px" }}
	figcaption="负压效应示意"
/>
...
<BlogImageContainer
	src={
    		"/images/docs/zh-CN/primer/what-is-the-difference-perforated-vs-solid-platforms/perforated-platform-left-&-solid-platform-right.png"
	}
	style={{ width: "600px" }}
	figcaption="打孔平台（左）&实心平台（右）"
/>
...
<BlogImageContainer
	src={
    		"/images/docs/zh-CN/primer/what-is-the-difference-perforated-vs-solid-platforms/drain-holes-in-the-model.gif"
	}
	style={{ width: "600px" }}
	figcaption="对模型进行打孔"
/>
...
<BlogImageContainer
	src={
    		"/images/docs/zh-CN/primer/what-is-the-difference-perforated-vs-solid-platforms/rendering-of-the-perforated-platform-model.png"
	}
	style={{ width: "600px" }}
	figcaption="打孔平台模型渲染"
/>
